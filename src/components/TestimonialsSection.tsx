  ...
  return <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => <Card key={index} className="p-8 hover:shadow-elegant transition-all duration-300 hover:scale-105 group">
        ...
        <div className="text-center mt-12">
          ...
          <div className="flex justify-center gap-2">
            {[...Array(5)].map((_, i) => <span key={i} className="text-2xl text-primary">⭐</span>)}
          </div>
        </div>
      </div>
    </section>;
