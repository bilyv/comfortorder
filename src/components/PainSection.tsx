        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {painPoints.map((point, index) => (
              <Card key={index} className="p-6 transition-all duration-500 hover:shadow-elegant hover:scale-105">
                ...
                <div className="space-y-4">
                  <div className={`p-4 rounded-lg transition-all duration-300 ${
                    activeView === 'without' 
                      ? 'bg-destructive/10 border border-destructive/20 ring-2 ring-destructive/30' 
                  ...
                  <div className={`p-4 rounded-lg transition-all duration-300 ${
                    activeView === 'with' 
                      ? 'bg-success/10 border border-success/20 ring-2 ring-success/30' 
                      : 'bg-muted/50 opacity-50'
                  }`}>
                    <div className="flex items-start gap-2 mb-2">
